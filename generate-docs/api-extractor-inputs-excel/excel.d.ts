export declare namespace ExcelScript {
    ...
    export interface Range {
         ...
         */
        clearAllConditionalFormat(): void;
    ...
    export interface RangeAreas {
        /**
         * Returns the RangeAreas reference in A1-style. Address value will contain the worksheet name for each rectangular block of cells (e.g. "Sheet1!A1:B4, Sheet1!D1:D4"). Read-only.
         */
        getAddress(): string;

        /**
         * Returns the RangeAreas reference in the user locale. Read-only.
         */
        getAddressLocal(): string;
